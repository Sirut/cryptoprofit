...
function updateResults() {
  ...
  // # Tot
  var difference_Tot = (difference_1 + difference_2 + difference_3) || 0;
  ...
  // // # Tot
  document.getElementById("difference_Tot").innerHTML = (difference_Tot).toFixed(6);
...
function reset1(){
  ...
  document.getElementById("difference_Tot").innerHTML = "";
